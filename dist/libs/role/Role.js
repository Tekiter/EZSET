...
class RoleSystem {
    ...
    role(roletag) {
        ...
        return new _Query2.default({ role: this._roles[roletag], mode: 'grant' });
    }
    ...
    default() {
        return new _Query2.default({ role: this._default });
    }
    ...
    createPermChecker(roles) {
        ...
        return (resource, param) => {
            ...
            roles.forEach(rname => {
                if (this._roles[rname] && this._roles[rname].resource(resource)) {
                    resources.push(this._roles[rname].resource(resource));
                }
            });

            return new _Permission2.default(resources, param);
        };
    }
}
...
class Role {
    ...
    createPermChecker() {
        return (resource, param) => {
            return new _Permission2.default(this._perm[resource], param);
        };
    }
